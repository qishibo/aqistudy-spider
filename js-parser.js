// mock window env
var jsdom = require("jsdom__no_cors");
...
global.localStorage = new LocalStorage('./localstorage_data');
...
// changeeeeeeeeeeeeeeeeeee sync_encryptjs
const askCqjmcofkq = "ajNdtudubESiBmHr";
const asibfJCC9wdl = "btNGSsEz7b0ibtWn";
const ackBc07Yvwuj = "dQdwwRizO8YmD6gj";
const aciGWpaar6yP = "fH6bGsU03RyYOHLL";
const dskuv3VVb4Cu = "hTqf4BKstzxlIzIX";
const dsi3eHGiqSTK = "xVNPGldlVpN8VtiP";
const dckYewUZNGAG = "oEvQiT2YIPAviyOw";
const dci6nhjGNsRa = "paPcaWF3WmORwUGK";
...
function decodeResponse(data) {
    ...
    data = DES.decrypt(data, dskuv3VVb4Cu, dsi3eHGiqSTK);
    data = AES.decrypt(data, askCqjmcofkq, asibfJCC9wdl);
    data = BASE64.decrypt(data);
    return data
}
var encodeParam = (function () {
    function ObjectSort(obj) {
        var newObject = {};
        Object.keys(obj).sort().map(function (key) {
            newObject[key] = obj[key]
    ...
    return function (method, obj) {
        var appId = '5a68158db26b30c19d53135e18ac1579';
        var clienttype = 'WEB';
...
function getFromServer(method, object, callback, period) {
    const key = hex_md5(method + JSON.stringify(object));
    const data = getDataFromLocalStorage(key, period);
    if (!data) {
        var param = encodeParam(method, object);
...
// custom program ============
var cliParams = process.argv
var method = 'GETDAYDATA';
var param = {};

// get param from cli
param.city = cliParams[2] ? cliParams[2] : '德州';
param.month = cliParams[3] ? cliParams[3] : '201312';
console.log(`node solving ... ${param.city} ${param.month}`)

// request from server and decode reponse
getFromServer(method, param, function(obj) {
